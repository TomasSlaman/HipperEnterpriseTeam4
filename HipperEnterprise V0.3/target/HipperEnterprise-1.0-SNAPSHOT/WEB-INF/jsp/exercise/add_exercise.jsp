...
<form:form class="form-horizontal" method="POST" commandName="exercise" action="${pageContext.request.contextPath}/exercise/add" >
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:errors path="exerciseName" style="color:red;"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:errors path="exerciseType" style="color:red;"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <form:input path="description" class="form-control" placeholder="Enter a description" />
        </div>
    </div>
